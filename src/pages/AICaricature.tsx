...
const AICaricature = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <SEOHead title="AI Caricature Generator | Instant Caricature from Photo" description="Upload your photo and get an instant AI-generated caricature! Creative Caricature Club™ AI tool creates fun caricatures you can print on T-shirts, mugs & more." canonical="/ai-caricature" />
