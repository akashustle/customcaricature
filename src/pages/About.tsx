...
const About = () => {
  ...
  return (
    <div className="min-h-screen brand-gradient-bg pb-16 md:pb-0">
      <SEOHead title="About Creative Caricature Club™ | India's #1 Caricature Studio" description="Creative Caricature Club™ is India's leading caricature studio founded by Ritesh Mahendra Gupta. Professional caricature artists for events, weddings & custom orders in Mumbai, India & internationally." canonical="/about" />
