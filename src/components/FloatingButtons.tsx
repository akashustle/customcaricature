...
const FloatingButtons = () => {
  ...
  return (
    <div className={`fixed z-[46] flex flex-col gap-3 ${isMobile ? "bottom-[120px] right-4" : "bottom-6 right-6"}`} style={{ pointerEvents: "auto" }}>
      {/* Theme Toggle */}
      <button
      ...
      {showInstagram && (
        <a
          ...
          className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] text-white flex items-center justify-center hover:opacity-90 transition-opacity shadow-lg"
      ...
      {/* WhatsApp - only when admin enabled */}
      {showWhatsapp && (
        <a
