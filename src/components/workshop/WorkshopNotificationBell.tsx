...
/**
 * Notification row for the workshop bell — mirrors the booking SwipeableNotifRow:
 *  - Tap-to-toggle-read via the dot button
 *  - Swipe-left on mobile to reveal a "Mark read/unread" action
 *  - Whole row remains tappable to navigate to the linked page
 */
const SwipeableWsNotifRow = ({
  notification: n,
  onClick,
  onToggleRead,
  getTypeIcon,
  ...
  const onTouchMove = (e: React.TouchEvent) => {
    ...
    setDragX(Math.max(-90, Math.min(0, dx)));
  };
  const onTouchEnd = () => {
